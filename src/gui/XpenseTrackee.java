 ...
 * @author vishalyadav
 */
public class XpenseTrackee extends javax.swing.JFrame {

    /**
     * Creates new form XpenseTrackee
     */
    public XpenseTrackee() {
        initComponents();
        displayCategory();
    ...
    try{
        ...
        while(rs.next()){
            category.addItem(rs.getNString("category"));
        }
    ...
    private void getEntries(){
        try{
            ...
            while(rs.next()){
                ...
                total+=t;
                Object o[]={rs.getInt(
             "sid"),rs.getString("category"),rs.getDate("sdate"),t};
                dtm.addRow(o);
            }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Last 20 days Spendings: ");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(totalAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 386, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        JOptionPane.showMessageDialog(null, "Design & Developed by Vishal Yadav \n Contact - vy24780@gmail.com \n 8418985692 \n THANK YOU"
                 );
 ...
 null, "Do you really wanna delete!", "Deletion Confirmation", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XpenseTrackee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XpenseTrackee().setVisible(true);
            }
        });
    }
